...
#define CONFIG_SECURE_FLASH_HAS_WRITE_PROTECTION_CACHE 1
#define CONFIG_SECURE_FLASH_UART_BOOTLOADER_ALLOW_ENC 1
#define CONFIG_SECURE_FLASH_SKIP_WRITE_PROTECTION_CACHE 1
#define CONFIG_SECURE_FLASH_ENCRYPT_ONLY_IMAGE_LEN_IN_APP_PART 1
